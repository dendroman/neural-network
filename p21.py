...
##
# new model using the saved parameters
##
...
# no need for optimizer this time
# as we wont train but rather load the pre-trained model
model.set(
    loss=Loss_CategoricalCrossentropy(),
    accuracy=Accuracy_Categorical()
)
...
##
# new model using the saved model
##
